...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card relative flex flex-col gap-4 overflow-hidden rounded-2xl bg-card py-4 text-sm text-card-foreground ring-1 ring-foreground/10",
        "[background-image:linear-gradient(to_bottom,oklch(1_0_0_/_0.045),oklch(1_0_0_/_0.005))]",
        "[--card-glow:transparent] [box-shadow:inset_0_1px_0_0_oklch(1_0_0_/_0.07),0_0_50px_-12px_var(--card-glow)]",
