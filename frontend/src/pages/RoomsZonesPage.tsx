...
import { CreateOrgDialog } from '@/components/CreateRoomDialog'
    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="rooms">
        ...
        <TabsContent value="zones" className="space-y-3 mt-4">
          <Button size="sm" onClick={() => setCreateType('zone')}><Plus size={14} className="mr-1" />Add Zone</Button>
      ...
      {createType && <CreateOrgDialog open={true} onOpenChange={(open) => { if (!open) setCreateType(null) }} type={createType} />}
    </div>
  )
}
